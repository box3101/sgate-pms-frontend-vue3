        ...
        <div class="mt-4 mb-4">
          ...
          <div class="report-submitter">
            <div class="submitter-header" @click="toggleSubmitter('chanYong')">
              ...
              <i
                class="icon icon-md"
                :class="isSubmitterOpen.chanYong ? 'icon-chevron-up' : 'icon-chevron-down'"
              ></i>
            </div>
          ...
          <div class="report-submitter">
            <div class="submitter-header" @click="toggleSubmitter('chanYong2')">
              ...
              <i
                class="icon icon-md"
                :class="isSubmitterOpen.chanYong2 ? 'icon-chevron-up' : 'icon-chevron-down'"
              ></i>
            </div>
            <div
          ...
          <div class="report-submitter">
            <div class="submitter-header" @click="toggleSubmitter('chanYong3')">
              ...
              <i
                class="icon icon-md"
                :class="isSubmitterOpen.chanYong3 ? 'icon-chevron-up' : 'icon-chevron-down'"
              ></i>
            </div>
            <div
              class="report-submitter-list flex flex-col gap-10"
