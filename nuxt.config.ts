...
export default defineNuxtConfig({
  ...
  app: {
    ...
    head: {
      viewport: 'width=1280, initial-scale=0.5, maximum-scale=1, user-scalable=no',
      meta: [
        { name: 'viewport', content: 'width=1280, initial-scale=0.5, maximum-scale=1, user-scalable=no' },
