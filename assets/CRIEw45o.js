import{_ as e}from"./4S9QGScc.js";import{B as b,c as r,a as l,b as d,w as n,t as s,o as i,F as a,g as p}from"./BLcxNUs1.js";const v={class:"table-guide-container container-large"},x={class:"guide-section"},h={class:"example-container"},T={class:"example-preview"},y={class:"guide-section"},g={class:"example-container"},U={class:"example-preview"},w={class:"example-container"},f={class:"example-preview"},z={class:"example-container"},B={class:"example-preview"},k={class:"example-container"},L={class:"example-preview"},S={class:"guide-section"},C={class:"example-container"},F={class:"example-preview"},N={class:"example-container"},V={class:"example-preview"},j={class:"example-container"},A={class:"example-preview"},D={class:"guide-section"},E={class:"example-container"},H={class:"example-preview"},P={class:"example-container"},$={class:"example-preview"},q={class:"example-container"},G={class:"example-preview"},I={class:"guide-section"},J={class:"example-container"},K={class:"example-preview"},M={class:"guide-section"},O={class:"example-container"},Q={class:"example-preview"},R={class:"guide-section"},W={class:"example-container"},X={class:"example-preview"},Y={class:"example-code"},Z={class:"example-container"},_={class:"example-preview"},c={class:"example-code"},ll={class:"guide-section"},tl={class:"guide-section"},sl={__name:"Table",setup(nl){const m=b("logoText");return m.value="UiTable 가이드",(o,t)=>(i(),r("div",v,[t[72]||(t[72]=l("h1",{class:"page-title"},"UiTable 컴포넌트 사용 가이드",-1)),l("section",x,[t[4]||(t[4]=l("h2",{class:"section-title"},"기본 사용법",-1)),t[5]||(t[5]=l("p",{class:"section-description"}," UiTable 컴포넌트는 다양한 스타일과 레이아웃 옵션을 제공하는 테이블 컴포넌트입니다. 기본적인 사용 방법은 다음과 같습니다. ",-1)),l("div",h,[t[2]||(t[2]=l("h3",{class:"example-title"},"기본 테이블",-1)),l("div",T,[d(e,null,{header:n(()=>t[0]||(t[0]=[l("tr",null,[l("th",null,"이름"),l("th",null,"나이"),l("th",null,"직업")],-1)])),body:n(()=>t[1]||(t[1]=[l("tr",null,[l("td",null,"홍길동"),l("td",null,"30"),l("td",null,"개발자")],-1),l("tr",null,[l("td",null,"김철수"),l("td",null,"25"),l("td",null,"디자이너")],-1),l("tr",null,[l("td",null,"이영희"),l("td",null,"28"),l("td",null,"기획자")],-1)])),_:1})]),t[3]||(t[3]=l("div",{class:"example-code"},[l("pre",null,[l("code",null,`<UiTable>
  <template #header>
    <tr>
      <th>이름</th>
      <th>나이</th>
