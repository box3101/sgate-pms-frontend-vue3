...
/>`)],-1))]),l("div",De,[o(n,{placeholder:"검색하세요",options:t,width:"100%"}),e[79]||(e[79]=l("p",{class:"select-desc"},"100% 너비",-1)),e[80]||(e[80]=l("div",{class:"code-example"},[l("pre",{class:"code-block"},`<UiSearchableSelect
  ...
  :options="options"
  width="100%"
/>`)],-1))])])]),l("section",Ce,[e[82]||(e[82]=l("h2",{class:"section-title"},"긴 옵션 목록",-1)),l("div",Xe,[l("div",Ee,[o(i,{placeholder:"선택하세요",options:N(v),modelValue:u.value,"onUpdate:modelValue":e[14]||(e[14]=s=>u.value=s)},null,8,["options","modelValue"]),l("p",Be,"기본 셀렉트 - 선택된 값: "+r(u.value||"없음"),1)]),l("div",je,[o(n,{placeholder:"검색하세요",options:N(v),modelValue:m.value,"onUpdate:modelValue":e[15]||(e[15]=s=>m.value=s)},null,8,["options","modelValue"]),l("p",Ie," 검색 가능한 셀렉트 - 선택된 값: "+r(m.value||"없음"),1)])])]),l("section",Ne,[e[83]||(e[83]=l("h2",{class:"section-title"},"검색 기능 활용",-1)),l("div",Ae,[l("div",We,[o(n,{placeholder:"국가를 검색하세요",options:V,modelValue:c.value,"onUpdate:modelValue":e[16]||(e[16]=s=>c.value=s)},null,8,["modelValue"]),l("p",$e," 국가 검색 - 선택된 국가: "+r(c.value?(I=V.find(s=>s.value===c.value))==null?void 0:I.label:"없음"),1)])]),e[84]||(e[84]=l("div",{class:"code-example mt-4"},[l("pre",{class:"code-block"},`<UiSearchableSelect
...
/>
  ...
  :options="options"
  v-model="multiSelectedValues"
/>`)],-1))]),l("div",Pe,[o(a,{size:"medium",placeholder:"다중 선택하세요",options:t,modelValue:C.value,"onUpdate:modelValue":e[19]||(e[19]=s=>C.value=s)},null,8,["modelValue"]),e[90]||(e[90]=l("p",{class:"select-desc"},"중간 사이즈 (Medium) - 기본",-1)),e[91]||(e[91]=l("div",{class:"code-example"},[l("pre",{class:"code-block"},`<UiMultiSelect
  size="medium"
  placeholder="다중 선택하세요"
  :options="options"
  v-model="multiSelectedValues"
/>`)],-1))]),l("div",Qe,[o(a,{size:"large",placeholder:"다중 선택하세요",options:t,modelValue:X.value,"onUpdate:modelValue":e[20]||(e[20]=s=>X.value=s)},null,8,["modelValue"]),e[92]||(e[92]=l("p",{class:"select-desc"},"큰 사이즈 (Large)",-1)),e[93]||(e[93]=l("div",{class:"code-example"},[l("pre",{class:"code-block"},`<UiMultiSelect
  size="large"
  placeholder="다중 선택하세요"
  :options="options"
  v-model="multiSelectedValues"
