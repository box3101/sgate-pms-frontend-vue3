...
}`)])],-1))])]),t("section",P,[a[18]||(a[18]=t("h2",{class:"section-title"},"수직 태그 그룹",-1)),a[19]||(a[19]=t("p",{class:"section-description"},"태그를 수직으로 정렬하는 태그 그룹입니다.",-1)),t("div",L,[t("div",O,[t("div",j,[d(n,{variant:"completed"},{default:i(()=>a[14]||(a[14]=[s("중요")])),_:1}),d(n,{variant:"deadline"},{default:i(()=>a[15]||(a[15]=[s("긴급")])),_:1}),d(n,{variant:"name"},{default:i(()=>a[16]||(a[16]=[s("주의")])),_:1})])]),a[17]||(a[17]=t("div",{class:"code-example"},[t("pre",null,[t("code",null,`<div class="tags-group tags-group--vertical">
