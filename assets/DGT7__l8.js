...
/>`)])],-1))])]),l("section",T,[e[11]||(e[11]=l("h2",{class:"section-title"},"크기 옵션",-1)),e[12]||(e[12]=l("p",{class:"section-description"}," size 속성을 사용하여 알림의 크기를 조절할 수 있습니다. (small, medium, large) ",-1)),l("div",C,[l("div",N,[s(t,{size:"small",type:"info",title:"작은 크기",message:"작은 크기의 알림 메시지입니다.",class:"mb-3"}),s(t,{size:"medium",type:"success",title:"중간 크기",message:"중간 크기의 알림 메시지입니다.",class:"mb-3"}),s(t,{size:"large",type:"warning",title:"큰 크기",message:"큰 크기의 알림 메시지입니다."})]),e[10]||(e[10]=l("div",{class:"example-code"},[l("pre",null,[l("code",null,`<UiAlert 
  size="small" 
  type="info" 
  title="작은 크기" 
...
/>`)])],-1))])]),l("section",S,[e[14]||(e[14]=l("h2",{class:"section-title"},"아이콘 숨기기",-1)),e[15]||(e[15]=l("p",{class:"section-description"}," showIcon 속성을 false로 설정하여 아이콘을 숨길 수 있습니다. ",-1)),l("div",H,[l("div",L,[s(t,{type:"info",title:"아이콘 없음",message:"아이콘이 없는 알림 메시지입니다.",showIcon:!1})]),e[13]||(e[13]=l("div",{class:"example-code"},[l("pre",null,[l("code",null,`<UiAlert 
  type="info" 
  title="아이콘 없음" 
